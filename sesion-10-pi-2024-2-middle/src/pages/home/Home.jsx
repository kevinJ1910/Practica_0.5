...
const Home = () => {
  ...
  // Función para manejar el movimiento del ratón y simular reproducir el audio al iniciar la aplicacion
  const handlePointerMove = useCallback(() => {
    if (!isPlaying && audioRef.current) {
      audioRef.current.play();
      audioRef.current.setVolume(10);
      setIsPlaying(true); // Marcar como que el audio ya está reproduciéndose
    }
  }, [isPlaying]);
